...
namespace API_CINE.Controllers
{
    ...
    {
        ICarteleraService _carteleraService;
        ...
        [HttpGet]
        public async Task<ActionResult<List<CarteleraDTO>>> Get()
        {
            return await _carteleraService.ListarCartelera();
        }
        ...
        //    [HttpGet("reporte1")]
        //    public async Task<ActionResult<List<reporte1>>> ListarsalaspromocionesCartelera()
        //    {
